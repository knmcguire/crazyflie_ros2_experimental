...
class CrazyflieWebotsDriver:
    def __init__(self, webots_node: Any):
    ...
    def step(self) -> None:
        ...
        # TODO: Find out why this multiplication is necessary...
        ...
        tick = 100  # This value makes sure that the position controller and attitude controller are always initiated
        ...
        self.m1_motor.setVelocity(-motor_power_m1 / scaling)
        self.m2_motor.setVelocity(motor_power_m2 / scaling)
        self.m3_motor.setVelocity(-motor_power_m3 / scaling)
        self.m4_motor.setVelocity(motor_power_m4 / scaling)
